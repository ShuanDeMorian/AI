  ...
  with open(out_file, 'wb') as writer:
    for idx,s in enumerate(story_fnames):
      ...
      #   story_file = os.path.join(dm_tokenized_stories_dir, s)
        ...
        print("Error: Couldn't find tokenized story file %s in either tokenized story directories %s. Was there an error during tokenization?" % (s, cnn_tokenized_stories_dir))
        # Check again if tokenized stories directories contain correct number of files
        print("Checking that the tokenized stories directories %s contain correct number of files..." % (cnn_tokenized_stories_dir))
        check_num_stories(cnn_tokenized_stories_dir, num_expected_cnn_stories)
        # check_num_stories(dm_tokenized_stories_dir, num_expected_dm_stories)
        raise Exception("Tokenized stories directories %s contain correct number of files but story file %s found in neither." % (cnn_tokenized_stories_dir, s))
